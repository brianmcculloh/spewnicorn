    ...
    */
	...
	new Creatures({
		...
		moveSet: [
			...
			{ dmg: [12] },
			{ dmg: [6, 6] },
			{ blk: [10], effects: [{ effect: "might", amount: -1, turns: 1, hex: true }] },
		],
	...
	new Creatures({
		...
		pattern: "random",
		moveSet: [
			{ effects: [{ effect: "might", amount: 2, turns: 2 }], p: 0.2 },
			{ dmg: [8], blk: [4], p: 0.2 },
			{ dmg: [4], blk: [8], p: 0.2 },
			{ dmg: [11], p: 0.2 },
			{ armor: [8], p: 0.2 },
	...
	new Creatures({
		...
		moveSet: [
			...
			{
				effects: [{ effect: "might", amount: 1, turns: 3 }],
				actions: [
	...
	new Creatures({
		...
		moveSet: [
			...
			{ dmg: [15], p: 0.2 },
			{ dmg: [9], blk: [5], p: 0.3 },
			{ abilities: [{ ability: "tank", hex: true }], dmg: [15], p: 0.3 },
		],
	}),
	...
	new Creatures({
		...
		pattern: "fixed",
		moveSet: [
			{ effects: [{ effect: "retaliate", amount: 2, turns: -1 }] },
			{ dmg: [20] },
			{ dmg: [8, 8], blk: [10] },
			{ armor: [4], effects: [{ effect: "retaliate", amount: 3, turns: -1 }] },
			{ dmg: [1, 2, 3, 4, 5] },
		],
	...
	new Creatures({
		...
		pattern: "fixed",
		moveSet: [
			{ dmg: [12], effects: [{ effect: "resistance", amount: 0.5, turns: 2 }] },
			{ abilities: [{ ability: "unreachable", turns: 1, enabled: true }] },
			{ dmg: [11, 11] },
			{ abilities: [{ ability: "unreachable", hex: true }], dmg: [1, 1, 1, 1, 1, 1, 1, 1] },
			{ blk: [12] },
			{ dmg: [25], blk: [5] },
			{ effects: [{ effect: "punch", amount: -0.4, turns: 3, hex: true }] },
			{
				abilities: [
	...
	new Creatures({
		...
		moveSet: [
			...
			{ armor: [15], dmg: [23], actions: [{ action: "removeHexes", to: "self" }], p: 0.1 },
			{ blk: [15], dmg: [23], actions: [{ action: "removeHexes", to: "self" }], p: 0.1 },
			{
				actions: [{ action: "summonMonster", what: ["swirler", "striker"], value: 2 }],
				p: 0.1,
			},
			{
				actions: [{ action: "summonMonster", what: ["blob", "flamehead"], value: 2 }],
				p: 0.1,
			},
		],
		resistance: { base: 0.5, current: 0, temp: [], turns: -1, persist: false },
	}),
	new Creatures({
		type: "monster",
		id: "power_liche",
		...
		moveSet: [
			{ dmg: [15] },
			{
				effects: [
					...
					{ effect: "resistance", amount: 0.3, turns: 2 },
		...
		moveSet: [
			{
				dmg: [20],
				blk: [25],
				effects: [{ effect: "regen", amount: 5, turns: -1 }],
				abilities: [{ ability: "protection", turns: -1, enabled: true }],
			},
			{
				blk: [25],
				effects: [
	...
	new Creatures({
		...
		pattern: "fixed",
		moveSet: [
			{ effects: [{ effect: "conjure", amount: -4, turns: 4, hex: true }] },
			{ dmg: [8, 8] },
			{ blk: [10], effects: [{ effect: "stifled", amount: 1, turns: -1, hex: true }] },
			{ dmg: [9, 9] },
			{ blk: [10], dmg: [10, 10] },
			{ dmg: [10, 10] },
			{ blk: [10] },
	...
	new Creatures({
		...
		moveSet: [
			...
			},
			{
				dmg: [22],
				effects: [{ effect: "might", amount: 2, turns: -1 }],
				abilities: [{ ability: "stockpile", turns: -1, enabled: true }],
				p: 0.1,
			},
			{ dmg: [34], p: 0.1 },
			{ dmg: [10], blk: [15], p: 0.1 },
		...
		moveSet: [
			{
				...
				effects: [
					...
					{ effect: "resistance", amount: 0.2, turns: 2 },
					{ effect: "vex", amount: 1, turns: -1 },
				],
				p: 0.1,
			},
	...
	new Creatures({
		...
		tier: 4,
		moveSet: [
			{ dmg: [15], effects: [{ effect: "punch", amount: -0.25, turns: -1, hex: true }] },
			{ abilities: [{ ability: "unreachable", turns: 1, enabled: true }] },
			{
				armor: [5],
				dmg: [25],
				effects: [{ effect: "vulnerable", amount: 1, turns: -1, hex: true }],
			},
			{ armor: [8], dmg: [25] },
			{ abilities: [{ ability: "unreachable", turns: 1, enabled: true }] },
			{ armor: [5], dmg: [25] },
	...
	new Creatures({
		...
		pattern: "random",
		moveSet: [
			{ effects: [{ effect: "might", amount: 3, turns: -1 }], dmg: [30], p: 0.3 },
			{ effects: [{ effect: "vex", amount: 1, turns: -1 }], dmg: [40], p: 0.3 },
			{ dmg: [50], p: 0.1 },
			{
				blk: [10],
				actions: [
	...
	new Creatures({
		...
		pattern: "random",
		moveSet: [
			{ blk: [12], armor: [10], p: 0.25 },
			{ dmg: [34], armor: [5], p: 0.25 },
			{
				effects: [{ effect: "resistance", amount: 0.8, turns: 2 }],
				dmg: [36],
				armor: [15],
				p: 0.25,
			},
			{ dmg: [16], blk: [10], armor: [10], p: 0.25 },
		],
	...
	new Creatures({
		...
		pattern: "fixed",
		moveSet: [
			{ effects: [{ effect: "regen", amount: 5, turns: -1 }], blk: [15] },
			{ dmg: [2, 2, 2, 2, 2, 2, 2, 2], effects: [{ effect: "might", amount: 1, turns: -1 }] },
			{
				dmg: [3, 3, 3, 3, 3, 3, 3, 3],
				effects: [{ effect: "punch", amount: -0.4, turns: 2, hex: true }],
			},
			{ dmg: [4, 4, 4, 4, 4, 4, 4, 4] },
		],
		...
		moveSet: [
			{
				blk: [25],
				abilities: [{ ability: "protection", turns: -1, enabled: true }],
				effects: [{ effect: "marked", amount: 1, turns: 5, hex: true }],
				actions: [
					{
						action: "stat",
						what: "might",
	...
	new Creatures({
		...
		moveSet: [
			{
				effects: [{ effect: "resistance", amount: 0.4, turns: 2 }],
				actions: [
					{
						action: "stat",
						what: "solid",
			...
			},
			{
				armor: [20],
				blk: [20],
				effects: [{ effect: "fatigued", amount: 1, turns: 6, hex: true }],
				actions: [
					{
						action: "stat",
						what: "solid",
			...
			},
			{
				...
				effects: [{ effect: "might", amount: 10, turn: 1 }],
			},
		],
		vex: { base: 1, current: 0, temp: [], turns: -1 },
	}),
		...
		moveSet: [
			{
				effects: [
					...
					{ effect: "sorcery", amount: -0.2, turns: 1, hex: true },
				],
				dmg: [3, 3, 3, 3, 3, 3, 3, 3],
				actions: [
					{
			...
			{
				effects: [{ effect: "conjure", amount: -5, turns: 1, hex: true }],
				actions: [
			...
			},
			{
				effects: [
					...
					{ effect: "sorcery", amount: -0.4, turns: 1, hex: true },
				],
				dmg: [4, 4, 4, 4, 4, 4, 4, 4],
				actions: [
					{
			...
			{
				effects: [{ effect: "conjure", amount: -5, turns: 2, hex: true }],
				actions: [
	...
	new Creatures({
		...
		pattern: "fixed",
		moveSet: [
			{ actions: [{ action: "removeBuffs", to: "player" }] },
			...
			{ blk: [20], dmg: [12, 12], effects: [{ effect: "might", amount: 6, turns: -1 }] },
			{
				dmg: [16],
				actions: [
					{ action: "removeBuffs", to: "player" },
	...
	new Creatures({
		...
		moveSet: [
			{ dmg: [35], armor: [30] },
			{ effects: [{ effect: "antimomentum", amount: 1, turns: -1, hex: true }] },
			{
				dmg: [30],
				effects: [
				...
				actions: [
					{
						...
						what: ["daggerhawk", "crystalice", "ghost_spider"],
						value: 2,
					},
				],
			},
			{ blk: [40], armor: [30] },
			{
				dmg: [20],
				abilities: [{ ability: "unreachable", turns: 1, enabled: true }],
				effects: [{ effect: "solid", amount: -2, turns: 2, hex: true }],
			},
			{
				blk: [45],
				effects: [
			...
			},
			{
				dmg: [30],
				armor: [30],
				actions: [{ action: "summonMonster", what: ["seraphim", "cherubim"], value: 2 }],
			},
			{ effects: [{ effect: "might", amount: 2, turns: -1 }] },
			{ blk: [45] },
			{ dmg: [35] },
			{
				...
				actions: [{ action: "removeHexes", to: "self" }],
			},
		],
	...
	new Creatures({
		...
		moveSet: [
			...
			{ effects: [{ effect: "retaliate", amount: 3, turns: -1 }] },
			{ effects: [{ effect: "retaliate", amount: 3, turns: -1 }] },
			{ effects: [{ effect: "retaliate", amount: 3, turns: -1 }] },
			{
				dmg: [1],
		...
		veil: { base: 0.5, current: 0, temp: [], turns: -1 },
	}),
	...
	new Creatures({
		...
		health: { base: 15, current: 0, max: 15 },
		pattern: "fixed",
		moveSet: [{ effects: [{ effect: "conjure", amount: -1, turns: 1, hex: true }] }],
	}),
	new Creatures({
		type: "monster",
		id: "daggerhawk",
		...
		moveSet: [
			...
			{ dmg: [2] },
			{ dmg: [1] },
			{ dmg: [40], actions: [{ action: "kill", to: "self" }] },
		],
	}),
	new Creatures({
		type: "monster",
	...
	new Creatures({
		...
		health: { base: 15, current: 0, max: 15 },
		pattern: "fixed",
		moveSet: [{ effects: [{ effect: "marked", amount: 1, turns: 1, hex: true }] }],
	}),
	new Creatures({
		type: "monster",
		id: "red_skeleton",
		...
		moveSet: [
			{
				...
				effects: [{ effect: "regen", amount: 1, turns: -1 }],
			},
			{
				actions: [
	...
	new Creatures({
		...
		health: { base: 15, current: 0, max: 15 },
		pattern: "fixed",
		moveSet: [{ effects: [{ effect: "might", amount: -1, turns: 1, hex: true }] }],
	}),
	new Creatures({
		type: "monster",
		id: "swirler",
		...
		health: { base: 15, current: 0, max: 15 },
		pattern: "fixed",
		moveSet: [{ effects: [{ effect: "punch", amount: -0.1, turns: 1, hex: true }] }],
	}),
	new Creatures({
		type: "monster",
		id: "ghost_spider",
...
export function Monster() {
	...
	async function addMonsterToDom(monster, id) {
		await appendMonster(monster, id);
	...
	function updateMonsterStats(monster) {
		...
		if (
			monster.health.current === undefined ||
			monster.health.current === false ||
			monster.health.current === "" ||
			isNaN(parseFloat(monster.health.current))
		) {
		...
		$(".monster[data-guid=" + monster.guid + "] .monster-armor").html(
			"armor: " + monster.armor
		);
		...
		if (monster.block == 0) {
			$(".monster[data-guid=" + monster.guid + "] .monster-health .block-amount").removeClass(
				"shown"
			);
			$(".monster[data-guid=" + monster.guid + "] .monster-health").removeClass("blocked");
		} else {
			$(".monster[data-guid=" + monster.guid + "] .monster-health .block-amount").addClass(
				"shown"
			);
			...
			switch (game.monsterGroup) {
				case 1:
					if (game.map == 1) {
						...
						let initial = 0;
						let increase = 20;
						let changeSeed = monsterNumChance(initial, increase);
						let num = chance(changeSeed) ? 2 : 1;
						...
						switch (game.floor) {
							case 1:
								...
								var numStandard = chance(75) ? 2 : 1;
								var numSuper = chance(75) ? 3 : 2;
							...
							case 3:
								...
								var numStandard = chance(80) ? 2 : 1;
								var numSuper = chance(80) ? 3 : 2;
								for (let i = 0; i < numStandard; i++) {
									let thisMonster = createMonster(
										1,
										i,
					...
					if (game.map == 1) {
						...
						switch (game.floor) {
							case 13:
								...
								var numStandard = chance(50) ? 3 : 2;
								var numSuper = chance(75) ? 2 : 2;
								for (let i = 0; i < numStandard; i++) {
									let thisMonster = createMonster(
										1,
										i,
				...
				case 7:
					if (game.map == 1) {
						...
						let initial = 40;
						let increase = 0;
						let chanceSeed = monsterNumChance(initial, increase);
						if (chance(chanceSeed)) {
							let thisMonster = createMonster(4, game, "normal", excluded);
							currentMonsters.push(thisMonster);
							for (let i = 0; i < 2; i++) {
	...
	function createMonster(
		...
		if (id) {
			...
			possibleMonsters = monsters.filter(
				(i) => i.tier == tier && i.category == category && i.context == context
			);
			possibleMonsters = possibleMonsters.filter(
				(x) => !excluded.filter((y) => y.id === x.id).length
			);

			if (breed) {
				// we're calling a direct breed of monster
		...
		for (let i = 0; i < game.effects.length; i++) {
			...
			if (
				((game.effects[i].id == "punch" ||
					...
					to[game.effects[i].id].current == 1) ||
				(game.effects[i].id != "punch" &&
					game.effects[i].id != "sorcery" &&
					game.effects[i].id != "thunder" &&
	...
	function updateStatusBar(to = false) {
		if (to) {
			...
			for (let i = 0; i < game.currentMonsters.length; i++) {
				...
				$(".monster[data-guid=" + thisMonster.guid + "] .status-bar").html(
					thisMonster.effectsDom + thisMonster.abilitiesDom + thisMonster.actionsDom
				);
			}
		}
	...
	function buildEffectsDom(to) {
		...
		if (to.breed == "ghost") {
			dom +=
				"<div class='single-status tooltip' style='background-position:-482px -6624px;' data-id='ghost' data-powertip='Ghost'></div>";
		}
				...
				if (
					...
					let turns =
						to[game.effects[i].id].turns > 0
							? '<span class="turns">' + to[game.effects[i].id].turns + "</span>"
							: "";
					let effectText = to[game.effects[i].id].current;
					if (
						game.effects[i].id == "punch" ||
						game.effects[i].id == "sorcery" ||
						game.effects[i].id == "resistance" ||
						game.effects[i].id == "thunder"
					) {
					...
					let desc =
						...
						game.effects[i].desc;
					dom +=
						"<div class='single-status status-effect tooltip' style='background-position:" +
						x +
						"px " +
						y +
						"px;' data-id='" +
		...
		for (let i = 0; i < game.abilities.length; i++) {
			if (to[game.abilities[i].id].enabled) {
				...
				let desc =
					...
					game.abilities[i].name +
					":</span> " +
					game.abilities[i].desc;
				let turns =
					to[game.abilities[i].id].turns > 0
						? '<span class="turns">' + to[game.abilities[i].id].turns + "</span>"
						: "";
				...
				dom +=
					"<div class='single-status status-ability tooltip' style='background-position:" +
					x +
					"px " +
					y +
					"px;' data-id='" +
	...
	function buildActionsDom(to) {
		...
		for (let i = 0; i < to.actions.length; i++) {
			...
			dom +=
				'<div class="single-status status-action tooltip" style="background-position:' +
				x +
				"px " +
				y +
				'px;" data-id="' +
...
export function Player() {
	...
	function addTreasure(treasure, player) {
		...
		appendTreasure(treasure, ".treasures");
	}
	...
	function addCandy(candy, player) {
		...
		if (slot.length > 0) {
			let clickable = true;
			appendCandy(candy, slot, clickable);
		}
	}
