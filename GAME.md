...
- [ ] echanic: confirm button when playing stance cards
...
- [x] Create and balance cards - DONE
- [x] Create and balance monsters and monster sets - DONE
- [x] Create and balance treasure - DONE
- [x] Create and balance candy - DONE
- [x] Create quests - DONE
...
- [ ] ine Tuning, Quality of Life fixes, and New Features
